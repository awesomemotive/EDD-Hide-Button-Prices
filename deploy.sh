...
PLUGINSLUG="easy-digital-downloads-hide-button-prices"
CURRENTDIR=`pwd`
MAINFILE="edd-hide-button-prices.php" # this should be the name of your main php file in the wordpress plugin
